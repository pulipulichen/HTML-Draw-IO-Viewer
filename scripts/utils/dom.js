...
export function getDomElements() {
    return {
        ...
        leftSidebar: getRequiredElement("leftSidebar"),
        sidebarToggleBtn: getRequiredElement("sidebarToggleBtn"),
        sidebarExpandBtn: getRequiredElement("sidebarExpandBtn"),
        ...
        attachMermaidThumbnailBtn: getRequiredElement("attachMermaidThumbnailBtn"),
